...
国内厂商：百度文心、腾讯混元、阿里通义、字节豆包、智谱AI、MiniMax、月之暗面(Kimi)、硅基流动
...
| 能力 | 说明 |
|------|------|
| **向量嵌入** | @cf/baai/bge-base-zh-v1.5 (768 维中文) |
...
| 功能 | 核心能力 |
|------|----------|
| **🪝 伏笔管理** | 自动提取伏笔 · 状态追踪(开放/收尾/放弃) · 重要性分级 · AI 检测收尾 |
| **📜 创作规则** | 定义写作风格/节奏/禁忌 · 优先级管理(1-5) · 分类管理(6大类) · 注入生成上下文 |
| **🌍 小说设定** | 世界观/境界体系/势力/地理/宝物功法 · 层级结构 · 关联关系 · 向量化检索 |
| **⚡ 境界追踪** | 自动检测突破事件 · 角色成长历程 · 突破历史记录 · 多体系支持 |
