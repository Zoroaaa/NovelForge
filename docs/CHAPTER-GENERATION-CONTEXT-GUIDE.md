...
> 版本: v4.1.0 | 模块: `server/services/contextBuilder.ts` + `server/routes/generate.ts`
...
| **创作节奏** | 无 | 无 | **新增 Slot-10** | 帮助 AI 均衡节奏 |
| 预算 | total=14k | total=55k | **total=128k** | 利用窗口 |
| RAG 次数 | 3 次 | **3 次** | **不变** | character/setting/foreshadowing 均保留 |
